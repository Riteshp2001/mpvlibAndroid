...
ci_tarball="prefix-ndk-${v_ndk}-lua-${v_lua}-mujs-${v_mujs}-unibreak-${v_unibreak}-harfbuzz-${v_harfbuzz}-fribidi-${v_fribidi}-freetype-${v_freetype}-mbedtls-${v_mbedtls}-curl-${v_curl}-openssl-${v_openssl}-ffmpeg-${v_ci_ffmpeg}.tgz"
